---
title: "Google Ads SOP for Small Business Owners"
slug: "google-ads-sop-small-business"
description: "A complete Google Ads standard operating procedure for small businesses. Weekly tasks, monthly checks, and quarterly optimizations."
category: "ads"
date: "2026-05-26"
hub_page: "/ads"
page_type: "spoke"
...
**Keywords.** If you've launched with a [tight campaign structure](/ads/google-ads-campaign-structure-lead-gen) — one campaign, a few ad groups, exact-match keywords you actually want to show for — those keywords are mostly done. You're not culling and rebuilding the keyword list every month. The search terms report is how you grow the keyword list organically, based on what's actually converting.
...
**Conversions dropped to zero.** This is the one that needs immediate attention. Check the conversion tracking first — a broken tag is the most common culprit by far. If tracking is intact, look at impression share and budget — did something change in the campaign settings? Did a payment method lapse? If you want a structured way to diagnose this, [the 30-minute audit](/ads/google-ads-account-audit-checklist) covers it systematically.

**Clicks are happening but no conversions.** This is a landing page problem more than an ads problem. The traffic is showing up — they're just not converting. Look at [whether your ads are actually working](/ads/how-to-tell-google-ads-working) as a diagnostic before assuming the account is broken.
...
Same goes if you're checking the account regularly but aren't sure what you're looking at. [The audit checklist](/ads/google-ads-account-audit-checklist) gives you a framework for evaluating the account from first principles. And if you want the full picture of what a well-run account's metrics should look like, [how to tell if your ads are working](/ads/how-to-tell-google-ads-working) covers the specific numbers.

The reason my service is priced the way it is — $800 setup, $200/month ongoing — is that the setup is where the value is. Monthly maintenance, for a well-built account, really is mostly search terms. I built software that handles the monitoring; I check the things that need a human. That's the model. For more of the SOPs and templates I actually use, see the [SOP library](/sop).
